...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalVariables = __webpack_require__(5);
	var pageSetup = __webpack_require__(3);
	var pageChanges = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uniqueFolders = function uniqueFolders(images) {
	  var foldersArray = [];
	  for (var i = 0; i < images.length; i++) {
	    foldersArray.push(images[i].folder[0]);
	  }
	  var uniqueArray = foldersArray.filter(function (elem, pos) {
	...
	var getImages = function getImages(event) {
	  event.preventDefault();
	  ...
	  $.ajax({
	    ...
	    if (imagesObject.ownedImages.length) {
	      ...
	      for (var _i = 0; _i < folders.length; _i++) {
	        ...
	        $('.files-table').append("<div class='folder-row' data-folder-name=" + folders[_i].replace(' ', '_') + ">" + folders[_i] + "</div>");
	      }
	    } else {
	...
	var moveImage = function moveImage(event) {
	  event.preventDefault();
	  var imageId = $('.move-image-submit')[0].dataset.imageId.toString();
	...
	var deleteImage = function deleteImage(event) {
	  event.preventDefault();
	...
	var openFolder = function openFolder() {
	  ...
	  if (images) {
	    ...
	    $('.files-table').append(imageTemplate({ images: images }));
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(29),depth0,{"name":"image","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.images : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<tr class=\"image-row image-number-"
	    ...
	    + "</a></td>\n  <td>"
	    + alias4(((helper = (helper = helpers.cleanCreatedAt || (depth0 != null ? depth0.cleanCreatedAt : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cleanCreatedAt","hash":{},"data":data}) : helper)))
	    + "</td>\n  <td>"
	    + alias4(((helper = (helper = helpers.cleanUpdatedAt || (depth0 != null ? depth0.cleanUpdatedAt : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cleanUpdatedAt","hash":{},"data":data}) : helper)))
	    + "</td>\n  <td>"
	    + alias4(((helper = (helper = helpers._ownerName || (depth0 != null ? depth0._ownerName : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_ownerName","hash":{},"data":data}) : helper)))
	    + "</td>\n  <td>"
	    ...
	    + "</td>\n  <!-- *TODO* wrap the final column with an if statement checking if the\n  currentuser is the owner - if so, show the button.\n  -->\n  <td>\n    <div class=\"dropdown\">\n      <button class=\"btn btn-primary image-options-button dropdown-toggle\" type=\"button\" id=\"image-options-button\" data-image-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" data-image-location=\""
	    + alias4(((helper = (helper = helpers.location || (depth0 != null ? depth0.location : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"location","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">\n        Options\n        <span class=\"caret\"></span>\n      </button>\n      <ul class=\"dropdown-menu\" aria-labelledby=\"image-options-button\">\n        <li><a class=\"modal-button move-image-button\" data-image-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" data-file-folder=\""
	    + alias4(((helper = (helper = helpers.folder || (depth0 != null ? depth0.folder : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"folder","hash":{},"data":data}) : helper)))
	    + "\" data-file-name=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#moveImageModal\" href=\"#\">Move file</a></li>\n        <li><a id=\"delete-image\" data-image-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" href=\"#\">Delete file</a></li>\n      </ul>\n    </div>\n  </td>\n</tr>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCollaborators = function getCollaborators(users) {
	  console.log('users length: ' + users.users.length);
	  console.log(globalVariables.user.collaborators);
	  var collaboratingUsers = [];
	  for (var i = 0; i < users.users.length; i++) {
	    for (var j = 0; j < globalVariables.user.collaborators.length; j++) {
	  ...
	  $('.collaborators').empty();
	  var collaboratorTemplate = __webpack_require__(31);
	  $('.collaborators').append(collaboratorTemplate({ collaboratingUsers: collaboratingUsers }));
	};

	var getUsers = function getUsers(event) {
	  event.preventDefault();
	  ...
	  $.ajax({
	    ...
	    console.log(users);
	    var userTemplate = __webpack_require__(33);
	    $('.all-users').append(userTemplate({ users: users }));
	  }).fail(function (jqxhr) {
	    console.error(jqxhr);
	  });
	};
	...
	var addCollaborator = function addCollaborator(event) {
	  var collaboratorId = event.target.dataset.userId;
	  ...
	  if (event.target.className.indexOf('chosen-collaborator') === -1) {
	    $.ajax({
	      ...
	      var newCollaborator = __webpack_require__(32);
	      $('.collaborators').append(newCollaborator({ collaboratorId: collaboratorId }));
	...
	var submitUserEdits = function submitUserEdits(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"collaborator","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.collaboratingUsers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"user-profile user-number-"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " chosen-collaborator\" data-user-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n  <img class=\"profile-logo\" src=\"assets/images/Logo.png\">\n  "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"user","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.users : depth0)) != null ? stack1.users : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
