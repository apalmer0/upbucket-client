...
/***/ function(module, exports, __webpack_require__) {
	...
	var getImages = function getImages(event) {
	  ...
	  $.ajax({
	    ...
	    var imagesObject = { userImages: userImages.images };
	    Object.assign(globalVariables, imagesObject);

	    if (globalVariables.userImages.length) {
	      var folders = uniqueFolders(globalVariables.userImages);
	...
	var editImage = function editImage(event) {
	  event.preventDefault();
	  var imageId = $('.edit-image-submit')[0].dataset.imageId.toString();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<tr class=\"image-row image-number-"
	    ...
	    + "\" data-file-name=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#editImageModal\" href=\"#\">Edit file</a></li>\n        <li><a id=\"delete-image\" data-image-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
